...
![](./data/final_slides.pdf){width="8in" height="5in"}
...
**Collection / Acquisition:** The data we used came from the NCO, which is a database owned by the Dutch government.
...
**Data understanding:** Each grade of school had roughly 150k+ students, so we decided that the sample size was large enough.
